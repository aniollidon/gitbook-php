...
### Activitats
 ...
 3. (Opcional) Crea una técnica d'encriptament i desencriptament pròpia i original, que funcioni per qualsevol caràcter UTF8 i el text encriptat resultant contingui només caràcters alfanumérics.
